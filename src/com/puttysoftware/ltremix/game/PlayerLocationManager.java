...
public final class PlayerLocationManager {
	...
	this.saveY = 0;
	this.saveZ = 0;
	this.playerData = new LowLevelNumberDataStore(PlayerLocationManager.PLAYER_DIMS,
		PlayerLocationManager.NUM_PLAYERS, PlayerLocationManager.NUM_ERAS);
	this.playerData.fill(-1);
	this.savedPlayerData = new LowLevelNumberDataStore(PlayerLocationManager.PLAYER_DIMS,
		PlayerLocationManager.NUM_PLAYERS, PlayerLocationManager.NUM_ERAS);
