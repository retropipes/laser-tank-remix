...
public class LoadTask extends Thread {
    ...
    public LoadTask(final String file, final boolean saved,
        ...
        this.pt.setMaximum(
                LoadTask.MAX_PROGRESS + AbstractArena.getProgressStages());
    }
        ...
        try {
            ...
            if (playerExists) {
                app.getGameManager().getPlayerManager().setPlayerLocation(
                        gameArena.getStartColumn(), gameArena.getStartRow(),
                        gameArena.getStartFloor());
            }
            if (!this.isSavedGame) {
                gameArena.save();
            }
