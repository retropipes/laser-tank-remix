...
public abstract class AbstractMovableObject extends AbstractArenaObject {
                ...
                try {
                    ...
                    if (this.getMaterial() == MaterialConstants.MATERIAL_MAGNETIC) {
                        if (laserType == LaserTypeConstants.LASER_TYPE_BLUE
                                && this.moveCheck(mof)) {
                            final boolean moved = this.preMoveObject(locX, locY,
                                    locZ, -dirX, -dirY, laserType, forceUnits);
                            if (moved) {
                                app.getGameManager().updatePushedPosition(locX,
                                        locY, locX - dirX, locY - dirY, this);
                                this.didMove = true;
                                app.getArenaManager().getArena()
                                        .fullScanMoveObjects(locZ, dirX, dirY);
                                this.playSoundHook();
                            } else {
                                // Object can't go that way
                                return super.laserEnteredAction(locX, locY,
                                        locZ, dirX, dirY, laserType,
                                        forceUnits);
                            }
     ...
     * @param forceUnits
     */
    protected boolean preMoveObject(final int locX, final int locY,
            final int locZ, final int dirX, final int dirY, final int laserType,
            final int forceUnits) {
        if (forceUnits >= this.getMinimumReactionForce()) {
            ...
            if (dirX == 0 && dirY == -1) {
                if (obj2 instanceof AbstractMovableObject
                        && !((AbstractMovableObject) obj2).didPreCheck) {
                    ((AbstractMovableObject) obj2).didPreCheck = true;
                    proceed = proceed && ((AbstractMovableObject) obj2)
                            .preMoveObject(locX, locY - 1, locZ, dirX, dirY,
                                    laserType, forceUnits
                                            - obj2.getMinimumReactionForce());
                    if (proceed) {
                        app.getGameManager().updatePushedPosition(locX,
                                locY - 1, locX + dirX, locY - 1 + dirY,
                ...
                if (obj4 instanceof AbstractMovableObject
                        && !((AbstractMovableObject) obj4).didPreCheck) {
                    ((AbstractMovableObject) obj4).didPreCheck = true;
                    proceed = proceed && ((AbstractMovableObject) obj4)
                            .preMoveObject(locX - 1, locY, locZ, dirX, dirY,
                                    laserType, forceUnits
                                            - obj4.getMinimumReactionForce());
                    if (proceed) {
                        app.getGameManager().updatePushedPosition(locX - 1,
                                locY, locX - 1 + dirX, locY + dirY,
                ...
                if (obj6 instanceof AbstractMovableObject
                        && !((AbstractMovableObject) obj6).didPreCheck) {
                    ((AbstractMovableObject) obj6).didPreCheck = true;
                    proceed = proceed && ((AbstractMovableObject) obj6)
                            .preMoveObject(locX + 1, locY, locZ, dirX, dirY,
                                    laserType, forceUnits
                                            - obj6.getMinimumReactionForce());
                    if (proceed) {
                        app.getGameManager().updatePushedPosition(locX + 1,
                                locY, locX + 1 + dirX, locY + dirY,
                ...
                if (obj8 instanceof AbstractMovableObject
                        && !((AbstractMovableObject) obj8).didPreCheck) {
                    ((AbstractMovableObject) obj8).didPreCheck = true;
                    proceed = proceed && ((AbstractMovableObject) obj8)
                            .preMoveObject(locX, locY + 1, locZ, dirX, dirY,
                                    laserType, forceUnits
                                            - obj8.getMinimumReactionForce());
                    if (proceed) {
                        app.getGameManager().updatePushedPosition(locX,
                                locY + 1, locX + dirX, locY + 1 + dirY,
