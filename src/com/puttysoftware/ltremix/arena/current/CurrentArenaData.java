...
public final class CurrentArenaData extends AbstractArenaData {
	...
	this.futureSavedTowerState = new LowLevelArenaDataStore(AbstractArenaData.MIN_ROWS,
		AbstractArenaData.MIN_COLUMNS, AbstractArenaData.MIN_FLOORS, ArenaConstants.NUM_LAYERS);
	this.startData = new LowLevelNumberDataStore(CurrentArenaData.PLAYER_DIMS, CurrentArenaData.NUM_PLAYERS,
		CurrentArenaData.NUM_ERAS);
	this.startData.fill(-1);
	this.savedStartData = new LowLevelNumberDataStore(CurrentArenaData.PLAYER_DIMS, CurrentArenaData.NUM_PLAYERS,
		CurrentArenaData.NUM_ERAS);
	...
	try {
	    ...
	    copy.savedStartData = (LowLevelNumberDataStore) this.savedStartData.clone();
    ...
    @Override
    public void writeData(final XDataWriter writer, final ProgressTracker pt) throws IOException {
	int y, x, z, w, e;
    ...
    @Override
    public AbstractArenaData readData(final XDataReader reader, final int formatVersion, final ProgressTracker pt)
	    throws IOException {
    ...
    private static CurrentArenaData readTowerG1(final XDataReader reader, final int ver, final ProgressTracker pt)
	    throws IOException {
    ...
    private static CurrentArenaData readTowerG2(final XDataReader reader, final int ver, final ProgressTracker pt)
	    throws IOException {
	int y, x, z, arenaSizeX, arenaSizeY, arenaSizeZ;
	arenaSizeX = reader.readInt();
	arenaSizeY = reader.readInt();
    ...
    private static CurrentArenaData readTowerG3(final XDataReader reader, final int ver, final ProgressTracker pt)
	    throws IOException {
	int y, x, z, arenaSizeX, arenaSizeY, arenaSizeZ;
	arenaSizeX = reader.readInt();
	arenaSizeY = reader.readInt();
    ...
    private static CurrentArenaData readTowerG4(final XDataReader reader, final int ver, final ProgressTracker pt)
	    throws IOException {
	int y, x, z, arenaSizeX, arenaSizeY, arenaSizeZ;
	arenaSizeX = reader.readInt();
	arenaSizeY = reader.readInt();
    ...
    private static CurrentArenaData readTowerG5(final XDataReader reader, final int ver, final ProgressTracker pt)
	    throws IOException {
    ...
    private static CurrentArenaData readTowerG6(final XDataReader reader, final int ver, final ProgressTracker pt)
	    throws IOException {
	int y, x, z, w, arenaSizeX, arenaSizeY, arenaSizeZ;
	arenaSizeX = reader.readInt();
	arenaSizeY = reader.readInt();
    ...
    private static CurrentArenaData readTowerG7(final XDataReader reader, final int ver, final ProgressTracker pt)
	    throws IOException {
    ...
    @Override
    public void writeSavedState(final XDataWriter writer, final ProgressTracker pt) throws IOException {
	int y, x, z, w;
	writer.writeInt(this.getColumns());
	writer.writeInt(this.getRows());
	writer.writeInt(this.getFloors());
    ...
    @Override
    public void readSavedState(final XDataReader reader, final int formatVersion, final ProgressTracker pt)
	    throws IOException {
	if (FormatConstants.isFormatVersionValidGeneration1(formatVersion)) {
    ...
    private void readSavedStateG2(final XDataReader reader, final int formatVersion, final ProgressTracker pt)
	    throws IOException {
    ...
    private void readSavedStateG3(final XDataReader reader, final int formatVersion, final ProgressTracker pt)
	    throws IOException {
	int y, x, z, saveSizeX, saveSizeY, saveSizeZ;
	saveSizeX = reader.readInt();
	saveSizeY = reader.readInt();
    ...
    private void readSavedStateG4(final XDataReader reader, final int formatVersion, final ProgressTracker pt)
	    throws IOException {
	int y, x, z, saveSizeX, saveSizeY, saveSizeZ;
	saveSizeX = reader.readInt();
	saveSizeY = reader.readInt();
    ...
    private void readSavedStateG5(final XDataReader reader, final int formatVersion, final ProgressTracker pt)
	    throws IOException {
    ...
    private void readSavedStateG6(final XDataReader reader, final int formatVersion, final ProgressTracker pt)
	    throws IOException {
	int y, x, z, w, saveSizeX, saveSizeY, saveSizeZ;
	saveSizeX = reader.readInt();
	saveSizeY = reader.readInt();
    ...
    private void readSavedStateG7(final XDataReader reader, final int formatVersion, final ProgressTracker pt)
	    throws IOException {
	int y, x, z, w, saveSizeX, saveSizeY, saveSizeZ;
	saveSizeX = reader.readInt();
	saveSizeY = reader.readInt();
