...
public class CurrentArena extends AbstractArena {
    ...
    private void readArenaLevelProgress(final XDataReader reader, final int formatVersion, final ProgressTracker pt)
	    throws IOException {
    ...
    private void writeArenaLevelProgress(final XDataWriter writer, final ProgressTracker pt) throws IOException {
	// Write the level
