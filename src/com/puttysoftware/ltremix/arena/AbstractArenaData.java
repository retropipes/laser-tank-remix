...
public abstract class AbstractArenaData implements Cloneable {
        ...
        public abstract void checkForEnemies(final int floorIn,
                        final int enemyLocXIn, final int enemyLocYIn,
                        final AbstractArenaObject enemy);

        public abstract int checkForMagnetic(final int floor, final int centerX,
                        final int centerY, final int dir);

        public abstract boolean linearScan(final int xIn, final int yIn,
                        final int zIn, final int d);

        public abstract int linearScanMagnetic(final int xIn, final int yIn,
                        final int zIn, final int d);

        public abstract int[] findObject(final int z, final String targetName);

        public abstract int[] tunnelScan(final int xIn, final int yIn,
                        final int zIn, final String targetName);

        public abstract void circularScanRange(final int xIn, final int yIn,
                        final int zIn, final int r, final int rangeType,
        ...
        public abstract void fullScanAllButtonOpen(final int zIn,
                        final AbstractButton source);

        public abstract void fullScanAllButtonClose(final int zIn,
                        final AbstractButton source);

        public abstract void fullScanButtonBind(final int dx, final int dy,
                        final int zIn, final AbstractButtonDoor source);

        public abstract void fullScanButtonCleanup(final int px, final int py,
                        final int zIn, final AbstractButton button);

        public abstract void fullScanFindButtonLostDoor(final int zIn,
        ...
        public abstract void resize(final int zIn,
                        final AbstractArenaObject nullFill);

        public abstract void resizeSavedState(final int z,
                        final AbstractArenaObject nullFill);

        public abstract void fillNulls(final AbstractArenaObject fill1,
        ...
        public abstract void writeData(final XDataWriter writer,
                        final ProgressTracker pt) throws IOException;

        public abstract AbstractArenaData readData(final XDataReader reader,
