...
public abstract class AbstractArenaData implements Cloneable {
    ...
    public abstract void writeData(final XDataWriter writer, final ProgressTracker pt) throws IOException;

    public abstract AbstractArenaData readData(final XDataReader reader, final int ver, final ProgressTracker pt)
	    throws IOException;

    public abstract void writeSavedState(final XDataWriter writer, final ProgressTracker pt) throws IOException;

    public abstract void readSavedState(final XDataReader reader, final int formatVersion, final ProgressTracker pt)
	    throws IOException;
