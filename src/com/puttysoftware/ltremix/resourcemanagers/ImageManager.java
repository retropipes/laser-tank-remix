...
public class ImageManager {
    ...
    private static final ImageTransform PAST = new ImageTransform(0.6, 0.6, 0.6,
            1);
    private static final ImageTransform PRESENT = new ImageTransform(1, 1, 1,
            1);
    private static final ImageTransform FUTURE = new ImageTransform(1, 1, 1,
            0.6);
    ...
    public static BufferedImageIcon getImage(final AbstractArenaObject obj,
        ...
        if (obj.getBaseImageName()
                .equals(StringLoader.loadImageString(
                        StringConstants.OBJECT_STRINGS_FILE,
    ...
    private static BufferedImageIcon applyTransform(
            final BufferedImageIcon source, final ImageTransform xform) {
        if (source == null) {
            return null;
        } else {
    ...
    static BufferedImageIcon getUncachedImage(final AbstractArenaObject obj,
        ...
        try {
            ...
            if (useText && customText != null) {
                if (ImageManager.DRAW_FONT == null) {
                    try (InputStream is = ImageManager.class
                        ...
                        ImageManager.DRAW_FONT = baseFont
                                .deriveFont(ImageManager.DRAW_SIZE * fontMult);
                ...
                g2.drawString(customText, ImageManager.DRAW_HORZ * fontMult,
                        ImageManager.DRAW_VERT * fontMult);
            }
